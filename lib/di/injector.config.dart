...
import '../features/poll/data/mapper/poll_mapper.dart' as _i17;
import '../features/poll/data/mapper/question_mapper.dart' as _i16;
...
import '../features/poll/domain/use_cases/submit_poll_use_case.dart' as _i12;
import '../features/poll/index.dart' as _i13;
import '../features/poll/presentation/manager/poll_form_bloc.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.PollFormBloc>(
      () => _i8.PollFormBloc(get<_i5.GetLatestPollUseCase>()));
  gh.factory<_i9.PollRemoteDataSource>(
      () => _i10.PollFireBaseRemoteDataSource(),
      instanceName: 'Firebase');
  gh.factory<_i11.QuestionTypeMapper>(() => _i11.QuestionTypeMapper());
  gh.lazySingleton<String>(() => appModule.baseUrl,
      instanceName: 'base_url', registerFor: {_prod, _dev});
  gh.factory<_i12.SubmitPollUseCase>(
      () => _i12.SubmitPollUseCase(get<_i13.PollRepository>()));
  gh.factory<_i14.PollClient>(() => _i14.PollClient(
      get<_i4.Dio>(instanceName: 'dio_client'),
      baseUrl: get<String>(instanceName: 'base_url')));
  gh.factory<_i9.PollRemoteDataSource>(
      () => _i15.PollApiRemoteDataSource(get<_i14.PollClient>()),
      instanceName: 'RestApi');
  gh.factory<_i16.QuestionMapper>(() => _i16.QuestionMapper(
      get<_i3.AnswerMapper>(), get<_i11.QuestionTypeMapper>()));
  gh.factory<_i17.PollMapper>(
      () => _i17.PollMapper(get<_i16.QuestionMapper>()));
  return get;
}
